...
(`docs/pipeline/diagnosis/Residuals.md`) — join a store's *actual* weather using exactly
...
[synthesize-sales](../../../pipeline/skills/synthesize-sales/scripts/synthesize_sales.py) and
[create_features.py](../../../pipeline/skills/dfm-create-features/scripts/create_features.py),
