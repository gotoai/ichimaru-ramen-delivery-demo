...
Implements the algorithm in docs/pipeline/synthetics/Sales.md: for every store in
...
Reads sampling/seed/time-horizon settings from pipeline/config/config.yaml (PyYAML). All
