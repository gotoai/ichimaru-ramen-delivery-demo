...
description: >-
  ...
  the mapping per docs/pipeline/synthetics/Match-store-weather-station.md. Reproduces the
...
following
[docs/pipeline/synthetics/Match-store-weather-station.md](../../../docs/pipeline/synthetics/Match-store-weather-station.md).
