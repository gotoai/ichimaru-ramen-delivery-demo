...
Implements docs/pipeline/diagnosis/Residuals.md. Tests whether the DFM's weather-feature
...
def find_repo_root(start: Path) -> Path:
    for p in [start, *start.parents]:
        if (p / "docs" / "pipeline" / "diagnosis" / "Residuals.md").exists():
            return p
    raise SystemExit("Could not locate repo root (docs/pipeline/diagnosis/Residuals.md not found).")
