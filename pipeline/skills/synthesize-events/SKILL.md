...
description: >-
  ...
  algorithm as synthesize-stores), driven by pipeline/config/config.yaml. Per prefecture in
...
Reproducible via `synthetics/random_seed` in `pipeline/config/config.yaml`. Options:
