...
description: >-
  ...
  per docs/pipeline/demand-forecast/dfm_modeling.md. Fits a LightGBM regressor
...
[docs/pipeline/demand-forecast/dfm_modeling.md](../../../docs/pipeline/demand-forecast/dfm_modeling.md).
...
- `pipeline/config/config.yaml` → `modeling/training/random_seed` — the fixed seed.
