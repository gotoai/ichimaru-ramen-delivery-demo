...
description: >-
  ...
  per docs/demand-forecast/dfm_features.md. One row per (store_name,
...
[docs/demand-forecast/dfm_features.md](../../../docs/demand-forecast/dfm_features.md).
...
- **No third-party dependencies** — standard library only (`csv`, `datetime`,
  ...
  `config/config.yaml`; the horizon/split rules are encoded from the spec.
