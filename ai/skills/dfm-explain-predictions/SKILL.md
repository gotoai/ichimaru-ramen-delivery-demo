...
description: >-
  ...
  docs/demand-forecast/dfm_explanation.md. Computes exact tree SHAP with LightGBM's
...
following
[docs/demand-forecast/dfm_explanation.md](../../../docs/demand-forecast/dfm_explanation.md).
Uses LightGBM's native exact tree SHAP (`booster.predict(..., pred_contrib=True)`) —
read the **Inference contract** in
[dfm_prediction.md](../../../docs/demand-forecast/dfm_prediction.md) first.
