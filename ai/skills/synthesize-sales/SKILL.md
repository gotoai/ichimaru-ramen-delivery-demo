...
description: >-
  ...
  algorithm in docs/synthetics/Sales.md. For every store in
...
[docs/synthetics/Sales.md](../../../docs/synthetics/Sales.md). One row per
...
- `config/config.yaml` — `synthetics/random_seed`, the `synthetics/sales/*`
