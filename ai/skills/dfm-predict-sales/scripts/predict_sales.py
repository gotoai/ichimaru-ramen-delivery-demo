...
Implements docs/demand-forecast/dfm_prediction.md. The serve-time, feed-forward
step:
...
def find_repo_root(start: Path) -> Path:
    for p in [start, *start.parents]:
        if (p / "docs" / "demand-forecast" / "dfm_prediction.md").exists():
            return p
    raise SystemExit("Could not locate repo root (docs/demand-forecast/dfm_prediction.md not found).")
