...
description: >-
  ...
  docs/demand-forecast/dfm_prediction.md. Loads the trained booster
...
[docs/demand-forecast/dfm_prediction.md](../../../docs/demand-forecast/dfm_prediction.md).
This is the serve-time, feed-forward step (no training). Read that spec and the
**Inference contract** in
[dfm_modeling.md](../../../docs/demand-forecast/dfm_modeling.md) first.
